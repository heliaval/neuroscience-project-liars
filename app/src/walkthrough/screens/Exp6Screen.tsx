      ...
      caveat={
        <>
          <Caveat>
            ...
            misread: the observing participant is not the same person in both blocks. Roles switch between the
            halves, so each line runs from one participant's early block to their partner's late block, not
            from one person's start to their finish. The power gate is also split across this experiment's
            sub-questions:{" "}
          ...
          <div className="mt-4 border border-hairline-strong bg-paper-raised p-4">
