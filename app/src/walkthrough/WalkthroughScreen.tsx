...
export function WalkthroughScreen({
  ...
  return (
    <div className="w-full px-8 py-6 sm:px-12 lg:px-16 xl:px-20">
      ...
      <div className="mt-4 grid grid-cols-1 items-center gap-x-10 gap-y-4 lg:grid-cols-[minmax(0,46ch)_minmax(0,1fr)]">
        <h2
