...
export function WalkthroughScreen({
  ...
  return (
    <div className="w-full px-6 py-2 sm:px-10 lg:px-16 xl:px-20">
      ...
      <div className="mt-2 grid grid-cols-1 items-center gap-x-10 gap-y-3 lg:grid-cols-[minmax(0,46ch)_minmax(0,1fr)]">
        <h2
