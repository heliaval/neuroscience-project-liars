...
export interface ResultsV1 {
  meta: {
    ...
    provenance: {
      ...
      trials: ProvenanceEnum;
      failures: ProvenanceEnum;
    };
    sources?: {
      [k: string]: unknown;
    };
  ...
  trials: [
    {
      ...
      partner_id: string;
      role: "deceiver" | "observer";
      slider_pos: number;
      session_order: number;
      round: number;
      dyad_trial_seq: number;
      condition: "lie" | "truth";
      outcome: string;
      ...
      interbrain_state_ref: "early_truth" | "early_deception" | "late_truth" | "late_deception";
    },
    {
      trial_uid: string;
      pair_id: string;
